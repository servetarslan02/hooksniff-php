...
class HookSniffHttpClient
{
    ...
    public function newReq(
        ...
        return new HookSniffRequest($method, $url);
    }

    /**
     * @throws ApiException
     */
    public function send(HookSniffRequest $req): ?string
    {
     ...
     * @throws ApiException
     */
    public function sendNoResponseBody(HookSniffRequest $req): void
    {
        $this->sendInner($req);
    }
     ...
     * @throws ApiException
     */
    private function sendInner(HookSniffRequest $req): array
    {
