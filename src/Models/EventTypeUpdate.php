...
class EventTypeUpdate implements \JsonSerializable
{
    ...
    {
        return new self(
            archived: \HookSniff\Utils::deserializeBool($data, 'archived', false, 'EventTypeUpdate'),
            deprecated: \HookSniff\Utils::deserializeBool($data, 'deprecated', false, 'EventTypeUpdate'),
            description: \HookSniff\Utils::deserializeString($data, 'description', true, 'EventTypeUpdate'),
            featureFlag: \HookSniff\Utils::deserializeString($data, 'featureFlag', false, 'EventTypeUpdate'),
            featureFlags: \HookSniff\Utils::getValFromJson($data, 'featureFlags', false, 'EventTypeUpdate'),
            groupName: \HookSniff\Utils::deserializeString($data, 'groupName', false, 'EventTypeUpdate'),
            schemas: \HookSniff\Utils::getValFromJson($data, 'schemas', false, 'EventTypeUpdate')
        );
    }
