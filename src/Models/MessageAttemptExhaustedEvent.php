...
class MessageAttemptExhaustedEvent implements \JsonSerializable
{
    ...
    {
        return new self(
            data: \HookSniff\Utils::deserializeObject($data, 'data', true, 'MessageAttemptExhaustedEvent', [MessageAttemptExhaustedEventData::class, 'fromMixed']),
            type: \HookSniff\Utils::getValFromJson($data, 'type', true, 'MessageAttemptExhaustedEvent')
        );
    }
