...
class EndpointHeadersOut implements \JsonSerializable
{
    ...
    {
        return new self(
            headers: \HookSniff\Utils::getValFromJson($data, 'headers', true, 'EndpointHeadersOut'),
            sensitive: \HookSniff\Utils::getValFromJson($data, 'sensitive', true, 'EndpointHeadersOut')
        );
    }
