...
class EventTypeIn implements \JsonSerializable
{
    ...
    {
        return new self(
            archived: \HookSniff\Utils::deserializeBool($data, 'archived', false, 'EventTypeIn'),
            deprecated: \HookSniff\Utils::deserializeBool($data, 'deprecated', false, 'EventTypeIn'),
            description: \HookSniff\Utils::deserializeString($data, 'description', true, 'EventTypeIn'),
            featureFlag: \HookSniff\Utils::deserializeString($data, 'featureFlag', false, 'EventTypeIn'),
            featureFlags: \HookSniff\Utils::getValFromJson($data, 'featureFlags', false, 'EventTypeIn'),
            groupName: \HookSniff\Utils::deserializeString($data, 'groupName', false, 'EventTypeIn'),
            name: \HookSniff\Utils::deserializeString($data, 'name', true, 'EventTypeIn'),
            schemas: \HookSniff\Utils::getValFromJson($data, 'schemas', false, 'EventTypeIn')
        );
    }
