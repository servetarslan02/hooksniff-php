...
class MessageOut implements \JsonSerializable
{
    ...
    {
        return new self(
            channels: \HookSniff\Utils::getValFromJson($data, 'channels', false, 'MessageOut'),
            deliverAt: \HookSniff\Utils::deserializeDt($data, 'deliverAt', false, 'MessageOut'),
            eventId: \HookSniff\Utils::deserializeString($data, 'eventId', false, 'MessageOut'),
            eventType: \HookSniff\Utils::deserializeString($data, 'eventType', true, 'MessageOut'),
            id: \HookSniff\Utils::deserializeString($data, 'id', true, 'MessageOut'),
            payload: \HookSniff\Utils::getValFromJson($data, 'payload', true, 'MessageOut'),
            tags: \HookSniff\Utils::getValFromJson($data, 'tags', false, 'MessageOut'),
            timestamp: \HookSniff\Utils::deserializeDt($data, 'timestamp', true, 'MessageOut')
        );
    }
