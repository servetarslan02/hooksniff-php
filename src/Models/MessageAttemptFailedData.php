...
class MessageAttemptFailedData implements \JsonSerializable
{
    ...
    {
        return new self(
            id: \HookSniff\Utils::deserializeString($data, 'id', true, 'MessageAttemptFailedData'),
            responseStatusCode: \HookSniff\Utils::deserializeInt($data, 'responseStatusCode', true, 'MessageAttemptFailedData'),
            timestamp: \HookSniff\Utils::deserializeDt($data, 'timestamp', true, 'MessageAttemptFailedData')
        );
    }
