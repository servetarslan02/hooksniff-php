...
class EndpointPatch implements \JsonSerializable
{
    ...
    {
        return new self(
            channels: \HookSniff\Utils::getValFromJson($data, 'channels', false, 'EndpointPatch'),
            description: \HookSniff\Utils::deserializeString($data, 'description', false, 'EndpointPatch'),
            disabled: \HookSniff\Utils::deserializeBool($data, 'disabled', false, 'EndpointPatch'),
            filterTypes: \HookSniff\Utils::getValFromJson($data, 'filterTypes', false, 'EndpointPatch'),
            metadata: \HookSniff\Utils::getValFromJson($data, 'metadata', false, 'EndpointPatch'),
            rateLimit: \HookSniff\Utils::deserializeInt($data, 'rateLimit', false, 'EndpointPatch'),
            secret: \HookSniff\Utils::deserializeString($data, 'secret', false, 'EndpointPatch'),
            throttleRate: \HookSniff\Utils::deserializeInt($data, 'throttleRate', false, 'EndpointPatch'),
            uid: \HookSniff\Utils::deserializeString($data, 'uid', false, 'EndpointPatch'),
            url: \HookSniff\Utils::getValFromJson($data, 'url', false, 'EndpointPatch'),
            version: \HookSniff\Utils::deserializeInt($data, 'version', false, 'EndpointPatch')
        );
    }
