...
class EndpointDisabledEventData implements \JsonSerializable
{
    ...
    {
        return new self(
            appId: \HookSniff\Utils::deserializeString($data, 'appId', true, 'EndpointDisabledEventData'),
            appUid: \HookSniff\Utils::deserializeString($data, 'appUid', false, 'EndpointDisabledEventData'),
            endpointId: \HookSniff\Utils::deserializeString($data, 'endpointId', true, 'EndpointDisabledEventData'),
            endpointUid: \HookSniff\Utils::deserializeString($data, 'endpointUid', false, 'EndpointDisabledEventData'),
            failSince: \HookSniff\Utils::deserializeDt($data, 'failSince', false, 'EndpointDisabledEventData'),
            trigger: \HookSniff\Utils::deserializeObject($data, 'trigger', false, 'EndpointDisabledEventData', [EndpointDisabledTrigger::class, 'fromMixed'])
        );
    }
