...
class EndpointUpdatedEvent implements \JsonSerializable
{
    ...
    {
        return new self(
            data: \HookSniff\Utils::deserializeObject($data, 'data', true, 'EndpointUpdatedEvent', [EndpointUpdatedEventData::class, 'fromMixed']),
            type: \HookSniff\Utils::getValFromJson($data, 'type', true, 'EndpointUpdatedEvent')
        );
    }
