...
class EventTypeImportOpenApiIn implements \JsonSerializable
{
    ...
    {
        return new self(
            dryRun: \HookSniff\Utils::deserializeBool($data, 'dryRun', false, 'EventTypeImportOpenApiIn'),
            replaceAll: \HookSniff\Utils::deserializeBool($data, 'replaceAll', false, 'EventTypeImportOpenApiIn'),
            spec: \HookSniff\Utils::getValFromJson($data, 'spec', false, 'EventTypeImportOpenApiIn'),
            specRaw: \HookSniff\Utils::deserializeString($data, 'specRaw', false, 'EventTypeImportOpenApiIn')
        );
    }
