...
class EventOut implements \JsonSerializable
{
    ...
    {
        return new self(
            eventType: \HookSniff\Utils::deserializeString($data, 'eventType', true, 'EventOut'),
            payload: \HookSniff\Utils::deserializeString($data, 'payload', true, 'EventOut'),
            timestamp: \HookSniff\Utils::deserializeDt($data, 'timestamp', true, 'EventOut')
        );
    }
