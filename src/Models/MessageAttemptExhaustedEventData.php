...
class MessageAttemptExhaustedEventData implements \JsonSerializable
{
    ...
    /**
     * Create an instance of MessageAttemptExhaustedEventData with required fields.
     */
    ...
    {
        return new self(
            appId: \HookSniff\Utils::deserializeString($data, 'appId', true, 'MessageAttemptExhaustedEventData'),
            appUid: \HookSniff\Utils::deserializeString($data, 'appUid', false, 'MessageAttemptExhaustedEventData'),
            endpointId: \HookSniff\Utils::deserializeString($data, 'endpointId', true, 'MessageAttemptExhaustedEventData'),
            lastAttempt: \HookSniff\Utils::deserializeObject($data, 'lastAttempt', true, 'MessageAttemptExhaustedEventData', [MessageAttemptFailedData::class, 'fromMixed']),
            msgEventId: \HookSniff\Utils::deserializeString($data, 'msgEventId', false, 'MessageAttemptExhaustedEventData'),
            msgId: \HookSniff\Utils::deserializeString($data, 'msgId', true, 'MessageAttemptExhaustedEventData')
        );
    }
