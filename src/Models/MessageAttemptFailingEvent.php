...
class MessageAttemptFailingEvent implements \JsonSerializable
{
    ...
    {
        return new self(
            data: \HookSniff\Utils::deserializeObject($data, 'data', true, 'MessageAttemptFailingEvent', [MessageAttemptFailingEventData::class, 'fromMixed']),
            type: \HookSniff\Utils::getValFromJson($data, 'type', true, 'MessageAttemptFailingEvent')
        );
    }
