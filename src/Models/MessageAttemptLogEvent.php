...
class MessageAttemptLogEvent implements \JsonSerializable
{
    ...
    {
        return new self(
            data: \HookSniff\Utils::deserializeObjectArray($data, 'data', true, 'MessageAttemptLogEvent', [MessageAttemptLog::class, 'fromMixed']),
            type: \HookSniff\Utils::getValFromJson($data, 'type', true, 'MessageAttemptLogEvent')
        );
    }
