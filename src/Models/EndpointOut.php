...
class EndpointOut implements \JsonSerializable
{
    ...
    {
        return new self(
            channels: \HookSniff\Utils::getValFromJson($data, 'channels', false, 'EndpointOut'),
            createdAt: \HookSniff\Utils::deserializeDt($data, 'createdAt', true, 'EndpointOut'),
            description: \HookSniff\Utils::deserializeString($data, 'description', true, 'EndpointOut'),
            disabled: \HookSniff\Utils::deserializeBool($data, 'disabled', false, 'EndpointOut'),
            filterTypes: \HookSniff\Utils::getValFromJson($data, 'filterTypes', false, 'EndpointOut'),
            id: \HookSniff\Utils::deserializeString($data, 'id', true, 'EndpointOut'),
            metadata: \HookSniff\Utils::getValFromJson($data, 'metadata', true, 'EndpointOut'),
            rateLimit: \HookSniff\Utils::deserializeInt($data, 'rateLimit', false, 'EndpointOut'),
            throttleRate: \HookSniff\Utils::deserializeInt($data, 'throttleRate', false, 'EndpointOut'),
            uid: \HookSniff\Utils::deserializeString($data, 'uid', false, 'EndpointOut'),
            updatedAt: \HookSniff\Utils::deserializeDt($data, 'updatedAt', true, 'EndpointOut'),
            url: \HookSniff\Utils::getValFromJson($data, 'url', true, 'EndpointOut'),
            version: \HookSniff\Utils::deserializeInt($data, 'version', true, 'EndpointOut')
        );
    }
