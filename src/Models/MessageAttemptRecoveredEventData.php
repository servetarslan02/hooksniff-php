...
class MessageAttemptRecoveredEventData implements \JsonSerializable
{
    ...
    {
        return new self(
            appId: \HookSniff\Utils::deserializeString($data, 'appId', true, 'MessageAttemptRecoveredEventData'),
            appUid: \HookSniff\Utils::deserializeString($data, 'appUid', false, 'MessageAttemptRecoveredEventData'),
            endpointId: \HookSniff\Utils::deserializeString($data, 'endpointId', true, 'MessageAttemptRecoveredEventData'),
            lastAttempt: \HookSniff\Utils::deserializeObject($data, 'lastAttempt', true, 'MessageAttemptRecoveredEventData', [MessageAttemptFailedData::class, 'fromMixed']),
            msgEventId: \HookSniff\Utils::deserializeString($data, 'msgEventId', false, 'MessageAttemptRecoveredEventData'),
            msgId: \HookSniff\Utils::deserializeString($data, 'msgId', true, 'MessageAttemptRecoveredEventData')
        );
    }
