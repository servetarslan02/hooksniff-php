...
class EventTypeImportOpenApiOutData implements \JsonSerializable
{
    ...
    {
        return new self(
            modified: \HookSniff\Utils::getValFromJson($data, 'modified', true, 'EventTypeImportOpenApiOutData'),
            toModify: \HookSniff\Utils::deserializeObjectArray($data, 'to_modify', true, 'EventTypeImportOpenApiOutData', [EventTypeFromOpenApi::class, 'fromMixed'])
        );
    }
