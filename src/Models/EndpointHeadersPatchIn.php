...
class EndpointHeadersPatchIn implements \JsonSerializable
{
    ...
    {
        return new self(
            deleteHeaders: \HookSniff\Utils::getValFromJson($data, 'deleteHeaders', false, 'EndpointHeadersPatchIn'),
            headers: \HookSniff\Utils::getValFromJson($data, 'headers', true, 'EndpointHeadersPatchIn')
        );
    }
