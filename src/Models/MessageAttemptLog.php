...
class MessageAttemptLog implements \JsonSerializable
{
    ...
    {
        return new self(
            appId: \HookSniff\Utils::deserializeString($data, 'appId', true, 'MessageAttemptLog'),
            appUid: \HookSniff\Utils::deserializeString($data, 'appUid', false, 'MessageAttemptLog'),
            attemptCount: \HookSniff\Utils::deserializeInt($data, 'attemptCount', true, 'MessageAttemptLog'),
            attemptEnd: \HookSniff\Utils::deserializeDt($data, 'attemptEnd', true, 'MessageAttemptLog'),
            attemptId: \HookSniff\Utils::deserializeString($data, 'attemptId', true, 'MessageAttemptLog'),
            attemptStart: \HookSniff\Utils::deserializeDt($data, 'attemptStart', true, 'MessageAttemptLog'),
            endpointId: \HookSniff\Utils::deserializeString($data, 'endpointId', true, 'MessageAttemptLog'),
            eventType: \HookSniff\Utils::deserializeString($data, 'eventType', false, 'MessageAttemptLog'),
            httpTimes: \HookSniff\Utils::deserializeObject($data, 'httpTimes', false, 'MessageAttemptLog', [HttpAttemptTimes::class, 'fromMixed']),
            msgCreated: \HookSniff\Utils::deserializeDt($data, 'msgCreated', true, 'MessageAttemptLog'),
            msgEventId: \HookSniff\Utils::deserializeString($data, 'msgEventId', false, 'MessageAttemptLog'),
            msgId: \HookSniff\Utils::deserializeString($data, 'msgId', true, 'MessageAttemptLog'),
            orgId: \HookSniff\Utils::deserializeString($data, 'orgId', true, 'MessageAttemptLog'),
            responseStatusCode: \HookSniff\Utils::deserializeInt($data, 'responseStatusCode', true, 'MessageAttemptLog'),
            status: \HookSniff\Utils::deserializeObject($data, 'status', true, 'MessageAttemptLog', [MessageStatus::class, 'fromMixed'])
        );
    }
