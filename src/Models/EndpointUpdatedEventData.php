...
class EndpointUpdatedEventData implements \JsonSerializable
{
    ...
    /**
     * Create an instance of EndpointUpdatedEventData with required fields.
     */
    ...
    {
        return new self(
            appId: \HookSniff\Utils::deserializeString($data, 'appId', true, 'EndpointUpdatedEventData'),
            appUid: \HookSniff\Utils::deserializeString($data, 'appUid', false, 'EndpointUpdatedEventData'),
            endpointId: \HookSniff\Utils::deserializeString($data, 'endpointId', true, 'EndpointUpdatedEventData'),
            endpointUid: \HookSniff\Utils::deserializeString($data, 'endpointUid', false, 'EndpointUpdatedEventData')
        );
    }
