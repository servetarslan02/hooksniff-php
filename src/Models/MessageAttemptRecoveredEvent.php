...
class MessageAttemptRecoveredEvent implements \JsonSerializable
{
    ...
    {
        return new self(
            data: \HookSniff\Utils::deserializeObject($data, 'data', true, 'MessageAttemptRecoveredEvent', [MessageAttemptRecoveredEventData::class, 'fromMixed']),
            type: \HookSniff\Utils::getValFromJson($data, 'type', true, 'MessageAttemptRecoveredEvent')
        );
    }
