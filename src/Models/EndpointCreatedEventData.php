...
class EndpointCreatedEventData implements \JsonSerializable
{
    ...
    /**
     * Create an instance of EndpointCreatedEventData with required fields.
     */
    ...
    {
        return new self(
            appId: \HookSniff\Utils::deserializeString($data, 'appId', true, 'EndpointCreatedEventData'),
            appUid: \HookSniff\Utils::deserializeString($data, 'appUid', false, 'EndpointCreatedEventData'),
            endpointId: \HookSniff\Utils::deserializeString($data, 'endpointId', true, 'EndpointCreatedEventData'),
            endpointUid: \HookSniff\Utils::deserializeString($data, 'endpointUid', false, 'EndpointCreatedEventData')
        );
    }
