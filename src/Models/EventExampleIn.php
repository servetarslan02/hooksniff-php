...
class EventExampleIn implements \JsonSerializable
{
    ...
    {
        return new self(
            eventType: \HookSniff\Utils::deserializeString($data, 'eventType', true, 'EventExampleIn'),
            exampleIndex: \HookSniff\Utils::deserializeInt($data, 'exampleIndex', false, 'EventExampleIn')
        );
    }
