...
class EndpointIn implements \JsonSerializable
{
    ...
    {
        return new self(
            channels: \HookSniff\Utils::getValFromJson($data, 'channels', false, 'EndpointIn'),
            description: \HookSniff\Utils::deserializeString($data, 'description', false, 'EndpointIn'),
            disabled: \HookSniff\Utils::deserializeBool($data, 'disabled', false, 'EndpointIn'),
            filterTypes: \HookSniff\Utils::getValFromJson($data, 'filterTypes', false, 'EndpointIn'),
            headers: \HookSniff\Utils::getValFromJson($data, 'headers', false, 'EndpointIn'),
            metadata: \HookSniff\Utils::getValFromJson($data, 'metadata', false, 'EndpointIn'),
            rateLimit: \HookSniff\Utils::deserializeInt($data, 'rateLimit', false, 'EndpointIn'),
            secret: \HookSniff\Utils::deserializeString($data, 'secret', false, 'EndpointIn'),
            throttleRate: \HookSniff\Utils::deserializeInt($data, 'throttleRate', false, 'EndpointIn'),
            uid: \HookSniff\Utils::deserializeString($data, 'uid', false, 'EndpointIn'),
            url: \HookSniff\Utils::getValFromJson($data, 'url', true, 'EndpointIn'),
            version: \HookSniff\Utils::deserializeInt($data, 'version', false, 'EndpointIn')
        );
    }
