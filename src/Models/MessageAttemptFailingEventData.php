...
class MessageAttemptFailingEventData implements \JsonSerializable
{
    ...
    /**
     * Create an instance of MessageAttemptFailingEventData with required fields.
     */
    ...
    {
        return new self(
            appId: \HookSniff\Utils::deserializeString($data, 'appId', true, 'MessageAttemptFailingEventData'),
            appUid: \HookSniff\Utils::deserializeString($data, 'appUid', false, 'MessageAttemptFailingEventData'),
            endpointId: \HookSniff\Utils::deserializeString($data, 'endpointId', true, 'MessageAttemptFailingEventData'),
            lastAttempt: \HookSniff\Utils::deserializeObject($data, 'lastAttempt', true, 'MessageAttemptFailingEventData', [MessageAttemptFailedData::class, 'fromMixed']),
            msgEventId: \HookSniff\Utils::deserializeString($data, 'msgEventId', false, 'MessageAttemptFailingEventData'),
            msgId: \HookSniff\Utils::deserializeString($data, 'msgId', true, 'MessageAttemptFailingEventData')
        );
    }
