...
class EventTypeFromOpenApi implements \JsonSerializable
{
    ...
    {
        return new self(
            deprecated: \HookSniff\Utils::deserializeBool($data, 'deprecated', true, 'EventTypeFromOpenApi'),
            description: \HookSniff\Utils::deserializeString($data, 'description', true, 'EventTypeFromOpenApi'),
            featureFlag: \HookSniff\Utils::deserializeString($data, 'featureFlag', false, 'EventTypeFromOpenApi'),
            featureFlags: \HookSniff\Utils::getValFromJson($data, 'featureFlags', false, 'EventTypeFromOpenApi'),
            groupName: \HookSniff\Utils::deserializeString($data, 'groupName', false, 'EventTypeFromOpenApi'),
            name: \HookSniff\Utils::deserializeString($data, 'name', true, 'EventTypeFromOpenApi'),
            schemas: \HookSniff\Utils::getValFromJson($data, 'schemas', false, 'EventTypeFromOpenApi')
        );
    }
