...
class EndpointEnabledEventData implements \JsonSerializable
{
    ...
    {
        return new self(
            appId: \HookSniff\Utils::deserializeString($data, 'appId', true, 'EndpointEnabledEventData'),
            appUid: \HookSniff\Utils::deserializeString($data, 'appUid', false, 'EndpointEnabledEventData'),
            endpointId: \HookSniff\Utils::deserializeString($data, 'endpointId', true, 'EndpointEnabledEventData'),
            endpointUid: \HookSniff\Utils::deserializeString($data, 'endpointUid', false, 'EndpointEnabledEventData')
        );
    }
