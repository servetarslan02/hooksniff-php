...
class EndpointDeletedEventData implements \JsonSerializable
{
    ...
    {
        return new self(
            appId: \HookSniff\Utils::deserializeString($data, 'appId', true, 'EndpointDeletedEventData'),
            appUid: \HookSniff\Utils::deserializeString($data, 'appUid', false, 'EndpointDeletedEventData'),
            endpointId: \HookSniff\Utils::deserializeString($data, 'endpointId', true, 'EndpointDeletedEventData'),
            endpointUid: \HookSniff\Utils::deserializeString($data, 'endpointUid', false, 'EndpointDeletedEventData')
        );
    }
