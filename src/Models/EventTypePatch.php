...
class EventTypePatch implements \JsonSerializable
{
    ...
    {
        return new self(
            archived: \HookSniff\Utils::deserializeBool($data, 'archived', false, 'EventTypePatch'),
            deprecated: \HookSniff\Utils::deserializeBool($data, 'deprecated', false, 'EventTypePatch'),
            description: \HookSniff\Utils::deserializeString($data, 'description', false, 'EventTypePatch'),
            featureFlag: \HookSniff\Utils::deserializeString($data, 'featureFlag', false, 'EventTypePatch'),
            featureFlags: \HookSniff\Utils::getValFromJson($data, 'featureFlags', false, 'EventTypePatch'),
            groupName: \HookSniff\Utils::deserializeString($data, 'groupName', false, 'EventTypePatch'),
            schemas: \HookSniff\Utils::getValFromJson($data, 'schemas', false, 'EventTypePatch')
        );
    }
