...
class EndpointCreatedEvent implements \JsonSerializable
{
    ...
    {
        return new self(
            data: \HookSniff\Utils::deserializeObject($data, 'data', true, 'EndpointCreatedEvent', [EndpointCreatedEventData::class, 'fromMixed']),
            type: \HookSniff\Utils::getValFromJson($data, 'type', true, 'EndpointCreatedEvent')
        );
    }
