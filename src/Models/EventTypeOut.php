...
class EventTypeOut implements \JsonSerializable
{
    ...
    {
        return new self(
            archived: \HookSniff\Utils::deserializeBool($data, 'archived', false, 'EventTypeOut'),
            createdAt: \HookSniff\Utils::deserializeDt($data, 'createdAt', true, 'EventTypeOut'),
            deprecated: \HookSniff\Utils::deserializeBool($data, 'deprecated', true, 'EventTypeOut'),
            description: \HookSniff\Utils::deserializeString($data, 'description', true, 'EventTypeOut'),
            featureFlag: \HookSniff\Utils::deserializeString($data, 'featureFlag', false, 'EventTypeOut'),
            featureFlags: \HookSniff\Utils::getValFromJson($data, 'featureFlags', false, 'EventTypeOut'),
            groupName: \HookSniff\Utils::deserializeString($data, 'groupName', false, 'EventTypeOut'),
            name: \HookSniff\Utils::deserializeString($data, 'name', true, 'EventTypeOut'),
            schemas: \HookSniff\Utils::getValFromJson($data, 'schemas', false, 'EventTypeOut'),
            updatedAt: \HookSniff\Utils::deserializeDt($data, 'updatedAt', true, 'EventTypeOut')
        );
    }
