...
/**
 * Confirm2faRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Confirm2faRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'Confirm2faRequest';
    ...
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) > 6)) {
            throw new \InvalidArgumentException('invalid length for $code when calling Confirm2faRequest., must be smaller than or equal to 6.');
        }
        if ((mb_strlen($code) < 6)) {
            throw new \InvalidArgumentException('invalid length for $code when calling Confirm2faRequest., must be bigger than or equal to 6.');
        }
