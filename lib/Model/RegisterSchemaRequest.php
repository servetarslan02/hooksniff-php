...
/**
 * RegisterSchemaRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RegisterSchemaRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'RegisterSchemaRequest';
     ...
     * Sets schema
     *
     * @param object $schema JSON Schema document
     *
     * @return self
     */
