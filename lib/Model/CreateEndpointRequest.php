...
/**
 * CreateEndpointRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateEndpointRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CreateEndpointRequest';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('format', $data ?? [], 'standard');
    }
