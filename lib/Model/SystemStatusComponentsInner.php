...
/**
 * SystemStatusComponentsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SystemStatusComponentsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SystemStatus_components_inner';
     ...
     * Sets last_checked
     *
     * @param string|null $last_checked last_checked
     *
     * @return self
     */
    public function setLastChecked($last_checked)
    {
        if (is_null($last_checked)) {
            throw new \InvalidArgumentException('non-nullable last_checked cannot be null');
        }
