 ...
 */
class DeployInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DeployInfo';
     ...
     * Sets version
     *
     * @param string|null $version Semantic version from Cargo.toml
     *
     * @return self
     */
     ...
     * Sets git_commit
     *
     * @param string|null $git_commit Git SHA of the deployed commit
     *
     * @return self
     */
    public function setGitCommit($git_commit)
    {
        if (is_null($git_commit)) {
            array_push($this->openAPINullablesSetToNull, 'git_commit');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('git_commit', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets build_time
     *
     * @param string|null $build_time ISO 8601 build timestamp
     *
     * @return self
     */
    public function setBuildTime($build_time)
    {
        if (is_null($build_time)) {
            array_push($this->openAPINullablesSetToNull, 'build_time');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('build_time', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets environment
     *
     * @param string|null $environment Deployment environment (production, staging, etc.)
     *
     * @return self
     */
