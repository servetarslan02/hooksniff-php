...
/**
 * UpdateNotificationPreferences Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateNotificationPreferences implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'UpdateNotificationPreferences';
    ...
    {
        $this->setIfExists('email_on_failure', $data ?? [], null);
        $this->setIfExists('email_on_dead_letter', $data ?? [], null);
        $this->setIfExists('email_on_success', $data ?? [], null);
