...
/**
 * InboundWebhookResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class InboundWebhookResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'InboundWebhookResponse';
     ...
     * Sets status
     *
     * @param string $status Processing status of the inbound webhook
     *
     * @return self
     */
