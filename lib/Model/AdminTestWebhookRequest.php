...
/**
 * AdminTestWebhookRequest Class Doc Comment
 *
 * @category Class
 * @description Send a test HTTP POST to a URL (admin)
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AdminTestWebhookRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AdminTestWebhookRequest';
