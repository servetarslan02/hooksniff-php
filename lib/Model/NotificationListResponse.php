...
/**
 * NotificationListResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class NotificationListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'NotificationListResponse';
    ...
    protected static $openAPITypes = [
        'notifications' => '\OpenAPI\Client\Model\Notification[]',
        'total' => 'int',
        'unread_count' => 'int'
    ];
