...
class SearchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'query' => 'string',
        'filters' => '\OpenAPI\Client\Model\SearchRequestFilters',
        'page' => 'int',
        'per_page' => 'int'
    ];
     ...
     * Gets filters
     *
     * @return \OpenAPI\Client\Model\SearchRequestFilters|null
     */
     ...
     * Sets filters
     *
     * @param \OpenAPI\Client\Model\SearchRequestFilters|null $filters filters
     *
     * @return self
     */
