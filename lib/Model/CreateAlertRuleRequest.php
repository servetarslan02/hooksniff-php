...
class CreateAlertRuleRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const CONDITION_FAILURE_RATE = 'failure_rate';
    public const CONDITION_LATENCY = 'latency';
    public const CONDITION_CONSECUTIVE_FAILURES = 'consecutive_failures';
    public const CHANNELS_SLACK = 'slack';
    public const CHANNELS_EMAIL = 'email';
    public const CHANNELS_WEBHOOK = 'webhook';
    ...
    {
        return [
            self::CONDITION_FAILURE_RATE,
            self::CONDITION_LATENCY,
            self::CONDITION_CONSECUTIVE_FAILURES,
        ];
    }
     ...
     * Sets name
     *
     * @param string $name Human-readable alert name
     *
     * @return self
     */
     ...
     * Sets condition
     *
     * @param string $condition Condition that triggers the alert
     *
     * @return self
     */
     ...
     * Sets threshold
     *
     * @param int $threshold Threshold value for the condition
     *
     * @return self
     */
     ...
     * Sets channels
     *
     * @param string[] $channels Notification channels to alert on
     *
     * @return self
     */
