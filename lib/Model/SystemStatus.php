 ...
 */
class SystemStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SystemStatus';
    ...
    protected static $openAPITypes = [
        ...
        'uptime_30d' => 'float',
        'components' => '\OpenAPI\Client\Model\SystemStatusComponentsInner[]',
        'checked_at' => 'string'
    ];
    ...
    public const OVERALL_STATUS_OPERATIONAL = 'operational';
    public const OVERALL_STATUS_DEGRADED = 'degraded';
    public const OVERALL_STATUS_DOWN = 'down';
    ...
    {
        return [
            self::OVERALL_STATUS_OPERATIONAL,
            self::OVERALL_STATUS_DEGRADED,
            self::OVERALL_STATUS_DOWN,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('uptime_30d', $data ?? [], null);
    ...
    {
        return $this->container['uptime_30d'];
    }
     ...
     * @return self
     */
    public function setUptime30d($uptime_30d)
    {
        if (is_null($uptime_30d)) {
            throw new \InvalidArgumentException('non-nullable uptime_30d cannot be null');
        }
        $this->container['uptime_30d'] = $uptime_30d;
