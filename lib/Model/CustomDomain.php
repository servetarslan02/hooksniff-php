...
class CustomDomain implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets domain
     *
     * @param string $domain The custom domain (e.g. webhooks.example.com)
     *
     * @return self
     */
     ...
     *
     * @param string|null $verification_token TXT record value to prove domain ownership
     *
     * @return self
     */
