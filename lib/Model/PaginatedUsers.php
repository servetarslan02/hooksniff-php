...
/**
 * PaginatedUsers Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PaginatedUsers implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaginatedUsers';
    ...
    protected static $openAPITypes = [
        'users' => '\OpenAPI\Client\Model\UserSummary[]',
        'total' => 'int',
        'page' => 'int',
        'per_page' => 'int'
    ];
