...
/**
 * SimulatorResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class SimulatorResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SimulatorResponse';
     ...
     * Sets latency_ms
     *
     * @param int $latency_ms Response time from the endpoint
     *
     * @return self
     */
