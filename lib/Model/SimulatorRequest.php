...
/**
 * SimulatorRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class SimulatorRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SimulatorRequest';
     ...
     * Sets event_type
     *
     * @param string $event_type Event type to simulate (e.g. order.created)
     *
     * @return self
     */
     ...
     * Sets payload
     *
     * @param object $payload The webhook payload to deliver
     *
     * @return self
     */
     ...
     * Sets delay_ms
     *
     * @param int|null $delay_ms Artificial delay before delivery (for testing timeouts)
     *
     * @return self
     */
