...
/**
 * DeliveryTrendResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DeliveryTrendResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DeliveryTrendResponse';
    ...
    protected static $openAPITypes = [
        'range' => 'string',
        'buckets' => '\OpenAPI\Client\Model\DeliveryTrendResponseBucketsInner[]'
    ];
