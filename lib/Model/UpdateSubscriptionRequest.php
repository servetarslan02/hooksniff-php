...
class UpdateSubscriptionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('proration', $data ?? [], true);
    }
     ...
     * Sets plan
     *
     * @param string $plan Target plan name
     *
     * @return self
     */
     ...
     * Sets proration
     *
     * @param bool|null $proration Whether to prorate charges for the current billing period
     *
     * @return self
     */
