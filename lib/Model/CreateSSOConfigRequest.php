...
/**
 * CreateSSOConfigRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateSSOConfigRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CreateSSOConfigRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['metadata_url'] === null) {
            $invalidProperties[] = "'metadata_url' can't be null";
        }
     ...
     * Sets metadata_url
     *
     * @param string $metadata_url URL to SAML metadata or OIDC discovery document
     *
     * @return self
     */
