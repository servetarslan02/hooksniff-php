...
/**
 * ServiceTokensIdRevealPost200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ServiceTokensIdRevealPost200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_service_tokens__id__reveal_post_200_response';
     ...
     * Sets token
     *
     * @param string|null $token Full token value (null if not available)
     *
     * @return self
     */
