...
class Verify2faRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'Verify2faRequest';
    ...
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) > 6)) {
            throw new \InvalidArgumentException('invalid length for $code when calling Verify2faRequest., must be smaller than or equal to 6.');
        }
        if ((mb_strlen($code) < 6)) {
            throw new \InvalidArgumentException('invalid length for $code when calling Verify2faRequest., must be bigger than or equal to 6.');
        }
