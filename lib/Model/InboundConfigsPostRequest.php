...
/**
 * InboundConfigsPostRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InboundConfigsPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_inbound_configs_post_request';
     ...
     * Sets provider
     *
     * @param string $provider Provider name (stripe, github, shopify, generic)
     *
     * @return self
     */
     ...
     * Sets endpoint_id
     *
     * @param string|null $endpoint_id Default target endpoint
     *
     * @return self
     */
