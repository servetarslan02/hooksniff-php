...
/**
 * Enable2faResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class Enable2faResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'Enable2faResponse';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['qr_url'] === null) {
            $invalidProperties[] = "'qr_url' can't be null";
        }
     ...
     * Sets qr_url
     *
     * @param string $qr_url QR code provisioning URL
     *
     * @return self
     */
