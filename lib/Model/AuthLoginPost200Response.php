...
/**
 * AuthLoginPost200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AuthLoginPost200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_auth_login_post_200_response';
    ...
    protected static $openAPITypes = [
        'token' => 'string',
        'customer' => '\OpenAPI\Client\Model\CustomerResponse',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('requires_2fa', $data ?? [], null);
     ...
     * Sets refresh_token
     *
     * @param string|null $refresh_token Refresh token (when applicable)
     *
     * @return self
     */
    ...
    {
        return $this->container['requires_2fa'];
    }
     ...
     * @return self
     */
    public function setRequires2fa($requires_2fa)
    {
        if (is_null($requires_2fa)) {
            throw new \InvalidArgumentException('non-nullable requires_2fa cannot be null');
        }
        $this->container['requires_2fa'] = $requires_2fa;
