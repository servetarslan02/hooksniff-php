...
/**
 * VerifyCustomDomainResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class VerifyCustomDomainResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'VerifyCustomDomainResponse';
    ...
    protected static $openAPITypes = [
        'status' => 'string',
        'dns_records' => '\OpenAPI\Client\Model\DomainDnsRecord[]'
    ];
     ...
     * Gets dns_records
     *
     * @return \OpenAPI\Client\Model\DomainDnsRecord[]
     */
     ...
     * Sets dns_records
     *
     * @param \OpenAPI\Client\Model\DomainDnsRecord[] $dns_records DNS records that need to be configured
     *
     * @return self
     */
