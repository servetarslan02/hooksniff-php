...
/**
 * AlertRuleListResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class AlertRuleListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AlertRuleListResponse';
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\Model\AlertRule[]',
        'has_more' => 'bool',
        'total' => 'int'
    ];
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\AlertRule[] $data data
     *
     * @return self
     */
