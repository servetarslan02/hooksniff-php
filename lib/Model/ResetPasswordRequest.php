...
class ResetPasswordRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ResetPasswordRequest';
    ...
    public function setNewPassword($new_password)
    {
        ...
        if ((mb_strlen($new_password) < 8)) {
            throw new \InvalidArgumentException('invalid length for $new_password when calling ResetPasswordRequest., must be bigger than or equal to 8.');
        }
