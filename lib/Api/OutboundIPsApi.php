...
/**
 * OutboundIPsApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class OutboundIPsApi
{
    ...
    /**
     * Operation outboundIpsGet
     *
     * Get outbound IP addresses for firewall whitelisting
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['outboundIpsGet'] to see the possible values for this operation
     *
    ...
    {
        list($response) = $this->outboundIpsGetWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation outboundIpsGetWithHttpInfo
     *
     * Get outbound IP addresses for firewall whitelisting
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['outboundIpsGet'] to see the possible values for this operation
     ...
     */
    public function outboundIpsGetAsync(string $contentType = self::contentTypes['outboundIpsGet'][0])
    {
        return $this->outboundIpsGetAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation outboundIpsGetAsyncWithHttpInfo
     *
     * Get outbound IP addresses for firewall whitelisting
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['outboundIpsGet'] to see the possible values for this operation
    ...
    /**
     * Create request for operation 'outboundIpsGet'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['outboundIpsGet'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     ...
     */
    public function outboundIpsGetRequest(string $contentType = self::contentTypes['outboundIpsGet'][0])
    {


        $resourcePath = '/outbound-ips';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
