...
$apiInstance = new OpenAPI\Client\Api\EmbedApi(
...
try {
    ...
    echo 'Exception when calling EmbedApi->embedGet: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling EmbedApi->embedScriptGet: ', $e->getMessage(), PHP_EOL;
}
```
