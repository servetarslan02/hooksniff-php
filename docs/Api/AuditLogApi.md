...
$apiInstance = new OpenAPI\Client\Api\AuditLogApi(
...
try {
    ...
    echo 'Exception when calling AuditLogApi->auditLogGet: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling AuditLogApi->auditLogIdGet: ', $e->getMessage(), PHP_EOL;
}
```
