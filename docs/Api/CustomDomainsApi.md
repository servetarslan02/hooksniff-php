...
try {
    ...
    echo 'Exception when calling CustomDomainsApi->customDomainsGet: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling CustomDomainsApi->customDomainsIdDelete: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling CustomDomainsApi->customDomainsIdVerifyPost: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
customDomainsPost($custom_domains_post_request)
```
...
$custom_domains_post_request = new \OpenAPI\Client\Model\CustomDomainsPostRequest(); // \OpenAPI\Client\Model\CustomDomainsPostRequest

try {
    $apiInstance->customDomainsPost($custom_domains_post_request);
} catch (Exception $e) {
    echo 'Exception when calling CustomDomainsApi->customDomainsPost: ', $e->getMessage(), PHP_EOL;
}
```
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **custom_domains_post_request** | [**\OpenAPI\Client\Model\CustomDomainsPostRequest**](../Model/CustomDomainsPostRequest.md)|  | [optional] |
